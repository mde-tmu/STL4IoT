...
public class SmartLightSystem implements IStatemachine, ITimed {
	...
	public enum State {
		...
		_SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT_,
		_SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT__UPDATING__WIFI_UPDATES_,
		_SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_WIFIGATEWAY_OFF,
	...
	*/
	...
	private void microStep() {
		...
		if (getStateConfVectorPosition()<4l) {
			...
			case _SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT__UPDATING__WIFI_UPDATES_:
				transitioned = _SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates__react(transitioned);
				break;
			case _SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_WIFIGATEWAY_OFF:
				transitioned = _SmartLightSystem__SmartLightSystem_WiFiGateway_off_react(transitioned);
				break;
			default:
				break;
			}
	...
	*/
	public synchronized boolean isStateActive(State state) {
		...
		case _SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT_:
			return stateVector[4].ordinal() >= State.
					_SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT_.ordinal()&& stateVector[4].ordinal() <= State._SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT__UPDATING__WIFI_UPDATES_.ordinal();
		case _SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT__UPDATING__WIFI_UPDATES_:
			return stateVector[4] == State._SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT__UPDATING__WIFI_UPDATES_;
		case _SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_WIFIGATEWAY_OFF:
			return stateVector[4] == State._SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_WIFIGATEWAY_OFF;
	...
	private void entryAction__SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates_() {
	...
	/* Entry action for state 'off'. */
	private void entryAction__SmartLightSystem__SmartLightSystem_WiFiGateway_off() {
		getWiFi().raiseOff();
	}
	...
	private void exitAction__SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates_() {
		timerService.unsetTimer(this, 5);
	}
	
	/* Exit action for state 'off'. */
	private void exitAction__SmartLightSystem__SmartLightSystem_WiFiGateway_off() {
		getWiFi().raiseOn();
	}
	...
	private void enterSequence__SmartLightSystem__SmartLightSystem_default() {
		...
		enterSequence__SmartLightSystem__SmartLightSystem_WiFiGateway_default();
	...
	private void enterSequence__SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__default() {
		enterSequence__SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__updating_default();
	}
	
	/* 'default' enter sequence for state <WiFi_Updates> */
	private void enterSequence__SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates__default() {
		entryAction__SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates_();
		stateVector[4] = State._SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT__UPDATING__WIFI_UPDATES_;
		stateConfVectorPosition = 4;
	}
	
	/* 'default' enter sequence for state off */
	private void enterSequence__SmartLightSystem__SmartLightSystem_WiFiGateway_off_default() {
		entryAction__SmartLightSystem__SmartLightSystem_WiFiGateway_off();
		stateVector[4] = State._SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_WIFIGATEWAY_OFF;
		stateConfVectorPosition = 4;
	}
	...
	private void enterSequence__SmartLightSystem__SmartLightSystem_WiFiGateway_default() {
		react__SmartLightSystem__SmartLightSystem_WiFiGateway__entry_Default();
	}
	
	/* 'default' enter sequence for region updating */
	private void enterSequence__SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__updating_default() {
		react__SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__updating__entry_Default();
	}
	...
	private void exitSequence__SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component_() {
		exitSequence__SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__updating();
	}
	
	/* Default exit sequence for state <WiFi_Updates> */
	private void exitSequence__SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates_() {
		stateVector[4] = State.$NULLSTATE$;
		stateConfVectorPosition = 4;
		
		exitAction__SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates_();
	}
	
	/* Default exit sequence for state off */
	private void exitSequence__SmartLightSystem__SmartLightSystem_WiFiGateway_off() {
		stateVector[4] = State.$NULLSTATE$;
		stateConfVectorPosition = 4;
		
		exitAction__SmartLightSystem__SmartLightSystem_WiFiGateway_off();
	}
	...
	private void exitSequence__SmartLightSystem_() {
		...
		switch (stateVector[4]) {
		case _SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT__UPDATING__WIFI_UPDATES_:
			exitSequence__SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates_();
			break;
		case _SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_WIFIGATEWAY_OFF:
			exitSequence__SmartLightSystem__SmartLightSystem_WiFiGateway_off();
			break;
		default:
			break;
		}
	...
	/* Default exit sequence for region updating */
	private void exitSequence__SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__updating() {
		switch (stateVector[4]) {
		case _SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT__UPDATING__WIFI_UPDATES_:
			exitSequence__SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates_();
			break;
	...
	/* Default react sequence for initial entry  */
	private void react__SmartLightSystem__SmartLightSystem_WiFiGateway__entry_Default() {
		getWiFi().enter();
		
		enterSequence__SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__default();
	}
	
	/* Default react sequence for initial entry  */
	private void react__SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__updating__entry_Default() {
		enterSequence__SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates__default();
	}
	...
	private long _SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__react(long transitioned_before) {
		long transitioned_after = transitioned_before;
		
		if (transitioned_after<4l) {
			if (system.off) {
				exitSequence__SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component_();
				enterSequence__SmartLightSystem__SmartLightSystem_WiFiGateway_off_default();
	...
	private long _SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates__react(long transitioned_before) {
		long transitioned_after = transitioned_before;
		...
		if (transitioned_after<4l) {
			if (timeEvents[5]) {
				...
				timeEvents[5] = false;
				enterSequence__SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates__default();
				_SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__react(4l);
		...
		/* If no transition was taken then execute local reactions */
		if (transitioned_after==transitioned_before) {
			transitioned_after = _SmartLightSystem__SmartLightSystem_WiFiGateway__Initialize_WiFi_Component__react(transitioned_before);
		}
		return transitioned_after;
	}
	
	private long _SmartLightSystem__SmartLightSystem_WiFiGateway_off_react(long transitioned_before) {
		long transitioned_after = transitioned_before;
