...
public class FireAlarm_Unit implements IStatemachine, ITimed {
	...
	public enum State {
		...
		_FIREALARM_UNIT___FIRE_ALARM_RUNNING__MONITORING_SENSOR_LEVEL__SENSOR_VALUE_MONITOR_ONSTANDBY_,
	...
	public FireAlarm_Unit() {
		...
		timer.setWarning_period(10l);
		
		timer.setFinal_warning_period(5l);
		...
		sensors.setSmoke_threshold(20l);
		
		sensors.setCarbon_threshold(20l);
	...
	*/
	...
	private void microStep() {
		...
		if (getStateConfVectorPosition()<2l) {
			...
			case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__MONITORING_SENSOR_LEVEL__THRESHOLD_REACHED__WARNING_BEFORE_SOUNDING_SOUNDALARM:
				...
				break;
			case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__MONITORING_SENSOR_LEVEL__SENSOR_VALUE_MONITOR_ONSTANDBY_:
				transitioned = _FireAlarm_Unit___Fire_Alarm_Running__Monitoring_Sensor_Level__Sensor_Value_Monitor_onStandby__react(transitioned);
				break;
			default:
				break;
			}
	...
	private void runCycle() {
		...
		do { 
			...
			nextEvent();
		} while ((((((((((((((timer.enable || timer.disable) || timer.reset) || mode.safe) || mode.warning) || mode.final_warning) || mode.danger) || alarm.off) || alarm.on) || timeEvents[0]) || timeEvents[1]) || timeEvents[2]) || timeEvents[3]) || timeEvents[4]));
	...
	*/
	public synchronized boolean isStateActive(State state) {
		...
		case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__MONITORING_SENSOR_LEVEL__SENSOR_TRIGGERED_:
			return stateVector[2].ordinal() >= State.
					_FIREALARM_UNIT___FIRE_ALARM_RUNNING__MONITORING_SENSOR_LEVEL__SENSOR_TRIGGERED_.ordinal()&& stateVector[2].ordinal() <= State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__MONITORING_SENSOR_LEVEL__SENSOR_TRIGGERED__CARBONSENSOR__MONITORING_CARBON_LEVEL_.ordinal();
		case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__MONITORING_SENSOR_LEVEL__SENSOR_TRIGGERED__SMOKESENSOR__MONITORING_SMOKE_LEVEL_:
		...
		case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__MONITORING_SENSOR_LEVEL__SENSOR_VALUE_MONITOR_ONSTANDBY_:
			return stateVector[2] == State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__MONITORING_SENSOR_LEVEL__SENSOR_VALUE_MONITOR_ONSTANDBY_;
		case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__TIMER_STATUS__DISABLED_:
			return stateVector[4] == State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__TIMER_STATUS__DISABLED_;
		case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__TIMER_STATUS__TIMER_RUNNING_:
			return stateVector[4].ordinal() >= State.
					_FIREALARM_UNIT___FIRE_ALARM_RUNNING__TIMER_STATUS__TIMER_RUNNING_.ordinal()&& stateVector[4].ordinal() <= State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__TIMER_STATUS__TIMER_RUNNING__R1__FINAL_WARNING_ENDED.ordinal();
		case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__TIMER_STATUS__TIMER_RUNNING__R1__FINAL_WARNING_:
			return stateVector[4] == State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__TIMER_STATUS__TIMER_RUNNING__R1__FINAL_WARNING_;
		case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__TIMER_STATUS__TIMER_RUNNING__R1__INITIAL_WARNING_:
			return stateVector[4] == State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__TIMER_STATUS__TIMER_RUNNING__R1__INITIAL_WARNING_;
		case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__TIMER_STATUS__TIMER_RUNNING__R1__FINAL_WARNING_ENDED:
			return stateVector[4] == State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__TIMER_STATUS__TIMER_RUNNING__R1__FINAL_WARNING_ENDED;
		default:
			return false;
		}
	}
	...
	/* Entry action for state '<Sensor_Value_Monitor_onStandby>'. */
	private void entryAction__FireAlarm_Unit___Fire_Alarm_Running__Monitoring_Sensor_Level__Sensor_Value_Monitor_onStandby_() {
	...
	private void exitAction__FireAlarm_Unit___Fire_Alarm_Running__Status_Warning() {
		setWarned(false);
	}
	...
	/* Exit action for state '<Sensor_Value_Monitor_onStandby>'. */
	private void exitAction__FireAlarm_Unit___Fire_Alarm_Running__Monitoring_Sensor_Level__Sensor_Value_Monitor_onStandby_() {
	...
	/* 'default' enter sequence for state <Sensor_Value_Monitor_onStandby> */
	private void enterSequence__FireAlarm_Unit___Fire_Alarm_Running__Monitoring_Sensor_Level__Sensor_Value_Monitor_onStandby__default() {
		entryAction__FireAlarm_Unit___Fire_Alarm_Running__Monitoring_Sensor_Level__Sensor_Value_Monitor_onStandby_();
		stateVector[2] = State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__MONITORING_SENSOR_LEVEL__SENSOR_VALUE_MONITOR_ONSTANDBY_;
		stateConfVectorPosition = 2;
	}
	...
	private void enterSequence__FireAlarm_Unit___Fire_Alarm_Running__Timer_Status__disabled__default() {
		stateVector[4] = State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__TIMER_STATUS__DISABLED_;
	...
	private void enterSequence__FireAlarm_Unit___Fire_Alarm_Running__Timer_Status__timer_running__r1__final_warning__default() {
		...
		stateVector[4] = State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__TIMER_STATUS__TIMER_RUNNING__R1__FINAL_WARNING_;
		stateConfVectorPosition = 4;
	}
	...
	private void enterSequence__FireAlarm_Unit___Fire_Alarm_Running__Timer_Status__timer_running__r1__initial_warning__default() {
		...
		stateVector[4] = State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__TIMER_STATUS__TIMER_RUNNING__R1__INITIAL_WARNING_;
		stateConfVectorPosition = 4;
	}
	...
	private void enterSequence__FireAlarm_Unit___Fire_Alarm_Running__Timer_Status__timer_running__r1__final_warning_ended_default() {
		...
		stateVector[4] = State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__TIMER_STATUS__TIMER_RUNNING__R1__FINAL_WARNING_ENDED;
		stateConfVectorPosition = 4;
	}
	...
	private void exitSequence__FireAlarm_Unit___Fire_Alarm_Running__Status_Warning() {
		...
		exitAction__FireAlarm_Unit___Fire_Alarm_Running__Status_Warning();
	}
	...
	/* Default exit sequence for state <Sensor_Value_Monitor_onStandby> */
	private void exitSequence__FireAlarm_Unit___Fire_Alarm_Running__Monitoring_Sensor_Level__Sensor_Value_Monitor_onStandby_() {
		stateVector[2] = State.$NULLSTATE$;
		stateConfVectorPosition = 2;
		
		exitAction__FireAlarm_Unit___Fire_Alarm_Running__Monitoring_Sensor_Level__Sensor_Value_Monitor_onStandby_();
	}
	...
	private void exitSequence__FireAlarm_Unit_() {
		...
		case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__MONITORING_SENSOR_LEVEL__THRESHOLD_REACHED__WARNING_BEFORE_SOUNDING_SOUNDALARM:
			...
			break;
		case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__MONITORING_SENSOR_LEVEL__SENSOR_VALUE_MONITOR_ONSTANDBY_:
			exitSequence__FireAlarm_Unit___Fire_Alarm_Running__Monitoring_Sensor_Level__Sensor_Value_Monitor_onStandby_();
			break;
		default:
			break;
		}
	...
	private void react__FireAlarm_Unit___Fire_Alarm_Running__Monitoring_Sensor_Level__entry_Default() {
		enterSequence__FireAlarm_Unit___Fire_Alarm_Running__Monitoring_Sensor_Level__Sensor_Value_Monitor_onStandby__default();
	}
	...
	private long _FireAlarm_Unit___Fire_Alarm_Running__Monitoring_Sensor_Level__Sensor_Value_Monitor_onStandby__react(long transitioned_before) {
		long transitioned_after = transitioned_before;
	...
	private long _FireAlarm_Unit___Fire_Alarm_Running__Timer_Status__timer_running__r1__final_warning__react(long transitioned_before) {
		...
		if (transitioned_after<4l) {
			if (timer.getCounter()<=0l) {
				...
				_FireAlarm_Unit___Fire_Alarm_Running__Timer_Status__timer_running__react(4l);
