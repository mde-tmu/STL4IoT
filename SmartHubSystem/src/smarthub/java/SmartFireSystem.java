...
public class SmartFireSystem implements IStatemachine, ITimed {
	...
	public enum State {
		...
		MAIN_REGION_SMARTFIRESYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT_,
		MAIN_REGION_SMARTFIRESYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT__UPDATING__WIFI_UPDATES_,
		MAIN_REGION_SMARTFIRESYSTEM_WIFIGATEWAY_OFF,
	...
	private void microStep() {
		...
		if (getStateConfVectorPosition()<3l) {
			...
			case MAIN_REGION_SMARTFIRESYSTEM_SENSORCOMPONENT__INITIALIZE_SENSOR_COMPONENT__UPDATING__SENSOR_UPDATES_:
				transitioned = main_region_SmartFireSystem_SensorComponent__Initialize_Sensor_Component__updating__Sensor_Updates__react(transitioned);
				break;
		...
		if (getStateConfVectorPosition()<4l) {
			...
			case MAIN_REGION_SMARTFIRESYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT__UPDATING__WIFI_UPDATES_:
				transitioned = main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates__react(transitioned);
				break;
			case MAIN_REGION_SMARTFIRESYSTEM_WIFIGATEWAY_OFF:
				transitioned = main_region_SmartFireSystem_WiFiGateway_off_react(transitioned);
				break;
			default:
				break;
			}
	...
	*/
	public synchronized boolean isStateActive(State state) {
		...
		case MAIN_REGION_SMARTFIRESYSTEM_SENSORCOMPONENT__INITIALIZE_SENSOR_COMPONENT_:
			return stateVector[3].ordinal() >= State.
					MAIN_REGION_SMARTFIRESYSTEM_SENSORCOMPONENT__INITIALIZE_SENSOR_COMPONENT_.ordinal()&& stateVector[3].ordinal() <= State.MAIN_REGION_SMARTFIRESYSTEM_SENSORCOMPONENT__INITIALIZE_SENSOR_COMPONENT__UPDATING__SENSOR_UPDATES_.ordinal();
		case MAIN_REGION_SMARTFIRESYSTEM_SENSORCOMPONENT__INITIALIZE_SENSOR_COMPONENT__UPDATING__SENSOR_UPDATES_:
			return stateVector[3] == State.MAIN_REGION_SMARTFIRESYSTEM_SENSORCOMPONENT__INITIALIZE_SENSOR_COMPONENT__UPDATING__SENSOR_UPDATES_;
		case MAIN_REGION_SMARTFIRESYSTEM_SENSORCOMPONENT_OFF:
			return stateVector[3] == State.MAIN_REGION_SMARTFIRESYSTEM_SENSORCOMPONENT_OFF;
		case MAIN_REGION_SMARTFIRESYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT_:
			return stateVector[4].ordinal() >= State.
					MAIN_REGION_SMARTFIRESYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT_.ordinal()&& stateVector[4].ordinal() <= State.MAIN_REGION_SMARTFIRESYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT__UPDATING__WIFI_UPDATES_.ordinal();
		case MAIN_REGION_SMARTFIRESYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT__UPDATING__WIFI_UPDATES_:
			return stateVector[4] == State.MAIN_REGION_SMARTFIRESYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT__UPDATING__WIFI_UPDATES_;
		case MAIN_REGION_SMARTFIRESYSTEM_WIFIGATEWAY_OFF:
			return stateVector[4] == State.MAIN_REGION_SMARTFIRESYSTEM_WIFIGATEWAY_OFF;
	...
	private void entryAction_main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates_() {
	...
	/* Entry action for state 'off'. */
	private void entryAction_main_region_SmartFireSystem_WiFiGateway_off() {
		getWiFi().raiseOff();
	}
	...
	private void exitAction_main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates_() {
		timerService.unsetTimer(this, 5);
	}
	
	/* Exit action for state 'off'. */
	private void exitAction_main_region_SmartFireSystem_WiFiGateway_off() {
		getWiFi().raiseOn();
	}
	...
	private void enterSequence_main_region_SmartFireSystem_default() {
		...
		enterSequence_main_region_SmartFireSystem_WiFiGateway_default();
	...
	private void enterSequence_main_region_SmartFireSystem_SensorComponent__Initialize_Sensor_Component__updating__Sensor_Updates__default() {
		...
		stateVector[3] = State.MAIN_REGION_SMARTFIRESYSTEM_SENSORCOMPONENT__INITIALIZE_SENSOR_COMPONENT__UPDATING__SENSOR_UPDATES_;
	...
	private void enterSequence_main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__default() {
		enterSequence_main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__updating_default();
	}
	
	/* 'default' enter sequence for state <WiFi_Updates> */
	private void enterSequence_main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates__default() {
		entryAction_main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates_();
		stateVector[4] = State.MAIN_REGION_SMARTFIRESYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT__UPDATING__WIFI_UPDATES_;
		stateConfVectorPosition = 4;
	}
	
	/* 'default' enter sequence for state off */
	private void enterSequence_main_region_SmartFireSystem_WiFiGateway_off_default() {
		entryAction_main_region_SmartFireSystem_WiFiGateway_off();
		stateVector[4] = State.MAIN_REGION_SMARTFIRESYSTEM_WIFIGATEWAY_OFF;
		stateConfVectorPosition = 4;
	}
	...
	private void enterSequence_main_region_SmartFireSystem_WiFiGateway_default() {
		react_main_region_SmartFireSystem_WiFiGateway__entry_Default();
	}
	
	/* 'default' enter sequence for region updating */
	private void enterSequence_main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__updating_default() {
		react_main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__updating__entry_Default();
	}
	...
	private void exitSequence_main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component_() {
		exitSequence_main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__updating();
	}
	
	/* Default exit sequence for state <WiFi_Updates> */
	private void exitSequence_main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates_() {
		stateVector[4] = State.$NULLSTATE$;
		stateConfVectorPosition = 4;
		
		exitAction_main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates_();
	}
	
	/* Default exit sequence for state off */
	private void exitSequence_main_region_SmartFireSystem_WiFiGateway_off() {
		stateVector[4] = State.$NULLSTATE$;
		stateConfVectorPosition = 4;
		
		exitAction_main_region_SmartFireSystem_WiFiGateway_off();
	}
	...
	private void exitSequence_main_region() {
		...
		switch (stateVector[4]) {
		case MAIN_REGION_SMARTFIRESYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT__UPDATING__WIFI_UPDATES_:
			exitSequence_main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates_();
			break;
		case MAIN_REGION_SMARTFIRESYSTEM_WIFIGATEWAY_OFF:
			exitSequence_main_region_SmartFireSystem_WiFiGateway_off();
			break;
		default:
			break;
		}
	...
	/* Default exit sequence for region updating */
	private void exitSequence_main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__updating() {
		switch (stateVector[4]) {
		case MAIN_REGION_SMARTFIRESYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT__UPDATING__WIFI_UPDATES_:
			exitSequence_main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates_();
			break;
	...
	/* Default react sequence for initial entry  */
	private void react_main_region_SmartFireSystem_WiFiGateway__entry_Default() {
		getWiFi().enter();
		
		enterSequence_main_region_SmartFireSystem_WiFiGateway_off_default();
	}
	
	/* Default react sequence for initial entry  */
	private void react_main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__updating__entry_Default() {
		enterSequence_main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates__default();
	}
	...
	private long main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__react(long transitioned_before) {
		long transitioned_after = transitioned_before;
		
		if (transitioned_after<4l) {
			if (system.off) {
				exitSequence_main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component_();
				enterSequence_main_region_SmartFireSystem_WiFiGateway_off_default();
	...
	private long main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates__react(long transitioned_before) {
		long transitioned_after = transitioned_before;
		...
		if (transitioned_after<4l) {
			if (timeEvents[5]) {
				...
				timeEvents[5] = false;
				enterSequence_main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__updating__WiFi_Updates__default();
				main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__react(4l);
		...
		/* If no transition was taken then execute local reactions */
		if (transitioned_after==transitioned_before) {
			transitioned_after = main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__react(transitioned_before);
		}
		return transitioned_after;
	}
	
	private long main_region_SmartFireSystem_WiFiGateway_off_react(long transitioned_before) {
		long transitioned_after = transitioned_before;
		
		if (transitioned_after<4l) {
			if (system.on) {
				exitSequence_main_region_SmartFireSystem_WiFiGateway_off();
				enterSequence_main_region_SmartFireSystem_WiFiGateway__Initialize_WiFi_Component__default();
				transitioned_after = 4l;
			}
		}
		return transitioned_after;
