...
public class TV_Unit implements IStatemachine, ITimed {
	...
	*/
	...
	private void runCycle() {
		...
		do { 
			...
			nextEvent();
		} while ((((((((change || device.on) || device.off) || input.toggle) || input.satellite) || input.cable) || input.hdmi) || timeEvents[0]));
