...
public class WiFi_Component implements IStatemachine, ITimed {
	public static class Wifi {
		private WiFi_Component parent;
		
		public Wifi(WiFi_Component parent) {
			this.parent = parent;
		}
	...
	protected boolean getIsExecuting() {
		synchronized(WiFi_Component.this) {
			return isExecuting;
		}
	}
	...
	public WiFi_Component() {
		...
		setTimeout_value(10l);
		
		setConnection(wifi.connection);
	...
	*/
	...
	private void runCycle() {
		...
		do { 
			...
			nextEvent();
		} while ((((((on || off) || wifi.force_timeout) || timeEvents[0]) || timeEvents[1]) || timeEvents[2]));
	...
	*/
	...
	private void exitAction_main_region_WiFi_Component_ConnectionStatus_checkingForWiFiConnection_CheckingForConnectionUpdate_connectingToServer() {
	...
	private void exitSequence_main_region_WiFi_Component_ConnectionStatus_checkingForWiFiConnection_CheckingForConnectionUpdate_connectingToServer() {
		...
		exitAction_main_region_WiFi_Component_ConnectionStatus_checkingForWiFiConnection_CheckingForConnectionUpdate_connectingToServer();
	}
	...
	private long main_region_WiFi_Component_ConnectionStatus_checkingForWiFiConnection_CheckingForConnectionUpdate_connectingToServer_react(long transitioned_before) {
		...
		if (transitioned_after<0l) {
			if ((timeEvents[0] || wifi.force_timeout)) {
	...
	private long main_region_WiFi_Component_ConnectionStatus_networkTimeout_react(long transitioned_before) {
		...
		if (transitioned_after<0l) {
			if (((timeEvents[2]) && (!wifi.getConnection()))) {
				exitSequence_main_region_WiFi_Component_ConnectionStatus_networkTimeout();
				timeEvents[2] = false;
				enterSequence_main_region_WiFi_Component_ConnectionStatus_checkingForWiFiConnection_CheckingForConnectionUpdate_connectingToServer_default();
				main_region_WiFi_Component_react(0l);
