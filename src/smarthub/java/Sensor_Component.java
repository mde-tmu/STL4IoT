...
public class Sensor_Component implements ITimed, IEventDriven {
	public enum State {
		...
		_SENSOR_COMPONENT___SENSOR_MONITORING___SENSING___NO_ACTIVITY_SENSED_,
		_SENSOR_COMPONENT___SENSOR_MONITORING___SENSING___ACTIVITY_SENSED_,
	...
	*/
	...
	private void microStep() {
		...
		case _SENSOR_COMPONENT___SENSOR_MONITORING___SENSING___NO_ACTIVITY_SENSED_:
			_Sensor_Component___Sensor_Monitoring___Sensing___No_Activity_Sensed__react(-1l);
			break;
		case _SENSOR_COMPONENT___SENSOR_MONITORING___SENSING___ACTIVITY_SENSED_:
			_Sensor_Component___Sensor_Monitoring___Sensing___Activity_Sensed__react(-1l);
			break;
	...
	*/
	public synchronized boolean isStateActive(State state) {
		...
		case _SENSOR_COMPONENT___SENSOR_MONITORING_:
			return stateVector[0].ordinal() >= State.
					_SENSOR_COMPONENT___SENSOR_MONITORING_.ordinal()&& stateVector[0].ordinal() <= State._SENSOR_COMPONENT___SENSOR_MONITORING___SENSING___ACTIVITY_SENSED_.ordinal();
		case _SENSOR_COMPONENT___SENSOR_MONITORING___SENSING___NO_ACTIVITY_SENSED_:
			return stateVector[0] == State._SENSOR_COMPONENT___SENSOR_MONITORING___SENSING___NO_ACTIVITY_SENSED_;
		case _SENSOR_COMPONENT___SENSOR_MONITORING___SENSING___ACTIVITY_SENSED_:
			return stateVector[0] == State._SENSOR_COMPONENT___SENSOR_MONITORING___SENSING___ACTIVITY_SENSED_;
		case _SENSOR_COMPONENT___OFF_:
	...
	private boolean environmentData;
	
	public synchronized boolean getEnvironmentData() {
		synchronized(Sensor_Component.this) {
			return environmentData;
		}
	}
	
	public void setEnvironmentData(boolean value) {
		synchronized(Sensor_Component.this) {
	...
	private void entryAction__Sensor_Component___Sensor_Monitoring___Sensing___No_Activity_Sensed_() {
		timerService.setTimer(this, 1, (1l * 1000l), false);
	}
	
	/* Entry action for state '<Activity_Sensed>'. */
	private void entryAction__Sensor_Component___Sensor_Monitoring___Sensing___Activity_Sensed_() {
	...
	private void exitAction__Sensor_Component___Sensor_Monitoring___Sensing___No_Activity_Sensed_() {
		timerService.unsetTimer(this, 1);
	}
	
	/* Exit action for state '<Activity_Sensed>'. */
	private void exitAction__Sensor_Component___Sensor_Monitoring___Sensing___Activity_Sensed_() {
	...
	private void enterSequence__Sensor_Component___Sensor_Monitoring___Sensing___No_Activity_Sensed__default() {
		entryAction__Sensor_Component___Sensor_Monitoring___Sensing___No_Activity_Sensed_();
		stateVector[0] = State._SENSOR_COMPONENT___SENSOR_MONITORING___SENSING___NO_ACTIVITY_SENSED_;
	}
	
	/* 'default' enter sequence for state <Activity_Sensed> */
	private void enterSequence__Sensor_Component___Sensor_Monitoring___Sensing___Activity_Sensed__default() {
		entryAction__Sensor_Component___Sensor_Monitoring___Sensing___Activity_Sensed_();
		stateVector[0] = State._SENSOR_COMPONENT___SENSOR_MONITORING___SENSING___ACTIVITY_SENSED_;
	}
	...
	private void exitSequence__Sensor_Component___Sensor_Monitoring___Sensing___No_Activity_Sensed_() {
		stateVector[0] = State.$NULLSTATE$;
		
		exitAction__Sensor_Component___Sensor_Monitoring___Sensing___No_Activity_Sensed_();
	}
	
	/* Default exit sequence for state <Activity_Sensed> */
	private void exitSequence__Sensor_Component___Sensor_Monitoring___Sensing___Activity_Sensed_() {
		stateVector[0] = State.$NULLSTATE$;
		
		exitAction__Sensor_Component___Sensor_Monitoring___Sensing___Activity_Sensed_();
	}
	...
	private void exitSequence__Sensor_Component_() {
		switch (stateVector[0]) {
		case _SENSOR_COMPONENT___SENSOR_MONITORING___SENSING___NO_ACTIVITY_SENSED_:
			exitSequence__Sensor_Component___Sensor_Monitoring___Sensing___No_Activity_Sensed_();
			exitAction__Sensor_Component___Sensor_Monitoring_();
			break;
		case _SENSOR_COMPONENT___SENSOR_MONITORING___SENSING___ACTIVITY_SENSED_:
			exitSequence__Sensor_Component___Sensor_Monitoring___Sensing___Activity_Sensed_();
			exitAction__Sensor_Component___Sensor_Monitoring_();
			break;
		case _SENSOR_COMPONENT___OFF_:
	...
	private void react__Sensor_Component___Sensor_Monitoring___Sensing___entry_Default() {
		enterSequence__Sensor_Component___Sensor_Monitoring___Sensing___No_Activity_Sensed__default();
	}
	...
	private long _Sensor_Component___Sensor_Monitoring___Sensing___No_Activity_Sensed__react(long transitioned_before) {
		long transitioned_after = transitioned_before;
		
		if (transitioned_after<0l) {
			if (activitySensed) {
				exitSequence__Sensor_Component___Sensor_Monitoring___Sensing___No_Activity_Sensed_();
				enterSequence__Sensor_Component___Sensor_Monitoring___Sensing___Activity_Sensed__default();
	...
	private long _Sensor_Component___Sensor_Monitoring___Sensing___Activity_Sensed__react(long transitioned_before) {
		long transitioned_after = transitioned_before;
