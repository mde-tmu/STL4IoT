...
public class LEDLight_Unit implements ITimed, IEventDriven {
	...
	public enum State {
		...
		_LED_LIGHT_UNIT___ON___BULB_STATUS__BULB_ON__BRIGHTNESS_LEVEL__CHANGE_BRIGHTNESS_LEVEL,
		$NULLSTATE$
	};
	...
	*/
	...
	private void microStep() {
		...
		case _LED_LIGHT_UNIT___ON___BULB_STATUS__BULB_ON_STANDBY:
			...
			break;
		case _LED_LIGHT_UNIT___ON___BULB_STATUS__BULB_ON__BRIGHTNESS_LEVEL__CHANGE_BRIGHTNESS_LEVEL:
			_LED_Light_Unit___On___Bulb_Status__Bulb_on__Brightness_LeveL__Change_Brightness_Level_react(-1l);
			break;
		default:
			break;
		}
	...
	*/
	public synchronized boolean isStateActive(State state) {
		...
		case _LED_LIGHT_UNIT___ON_:
			return stateVector[0].ordinal() >= State.
					_LED_LIGHT_UNIT___ON_.ordinal()&& stateVector[0].ordinal() <= State._LED_LIGHT_UNIT___ON___BULB_STATUS__BULB_ON__BRIGHTNESS_LEVEL__CHANGE_BRIGHTNESS_LEVEL.ordinal();
		case _LED_LIGHT_UNIT___ON___BULB_STATUS__BULB_ON_STANDBY:
		...
		case _LED_LIGHT_UNIT___ON___BULB_STATUS__BULB_ON:
			return stateVector[0].ordinal() >= State.
					_LED_LIGHT_UNIT___ON___BULB_STATUS__BULB_ON.ordinal()&& stateVector[0].ordinal() <= State._LED_LIGHT_UNIT___ON___BULB_STATUS__BULB_ON__BRIGHTNESS_LEVEL__CHANGE_BRIGHTNESS_LEVEL.ordinal();
		case _LED_LIGHT_UNIT___ON___BULB_STATUS__BULB_ON__BRIGHTNESS_LEVEL__CHANGE_BRIGHTNESS_LEVEL:
			return stateVector[0] == State._LED_LIGHT_UNIT___ON___BULB_STATUS__BULB_ON__BRIGHTNESS_LEVEL__CHANGE_BRIGHTNESS_LEVEL;
		default:
			return false;
		}
	}
	...
	private void enterSequence__LED_Light_Unit___On___Bulb_Status__Bulb_on_default() {
		...
		enterSequence__LED_Light_Unit___On___Bulb_Status__Bulb_on__Brightness_LeveL__default();
	}
	
	/* 'default' enter sequence for state Change_Brightness_Level */
	private void enterSequence__LED_Light_Unit___On___Bulb_Status__Bulb_on__Brightness_LeveL__Change_Brightness_Level_default() {
		stateVector[0] = State._LED_LIGHT_UNIT___ON___BULB_STATUS__BULB_ON__BRIGHTNESS_LEVEL__CHANGE_BRIGHTNESS_LEVEL;
	}
	...
	private void enterSequence__LED_Light_Unit___On___Bulb_Status__Bulb_on__Brightness_LeveL__default() {
		react__LED_Light_Unit___On___Bulb_Status__Bulb_on__Brightness_LeveL___entry_Default();
	}
	...
	private void exitSequence__LED_Light_Unit___On___Bulb_Status__Bulb_on() {
		exitSequence__LED_Light_Unit___On___Bulb_Status__Bulb_on__Brightness_LeveL_();
		exitAction__LED_Light_Unit___On___Bulb_Status__Bulb_on();
	}
	
	/* Default exit sequence for state Change_Brightness_Level */
	private void exitSequence__LED_Light_Unit___On___Bulb_Status__Bulb_on__Brightness_LeveL__Change_Brightness_Level() {
		stateVector[0] = State.$NULLSTATE$;
	}
	...
	private void exitSequence__LED_Light_Unit_() {
		...
		case _LED_LIGHT_UNIT___ON___BULB_STATUS__BULB_ON_STANDBY:
			...
			break;
		case _LED_LIGHT_UNIT___ON___BULB_STATUS__BULB_ON__BRIGHTNESS_LEVEL__CHANGE_BRIGHTNESS_LEVEL:
			exitSequence__LED_Light_Unit___On___Bulb_Status__Bulb_on__Brightness_LeveL__Change_Brightness_Level();
			exitAction__LED_Light_Unit___On___Bulb_Status__Bulb_on();
			break;
		default:
			break;
	...
	private void exitSequence__LED_Light_Unit___On___Bulb_Status__Bulb_on__Brightness_LeveL_() {
		switch (stateVector[0]) {
		case _LED_LIGHT_UNIT___ON___BULB_STATUS__BULB_ON__BRIGHTNESS_LEVEL__CHANGE_BRIGHTNESS_LEVEL:
			exitSequence__LED_Light_Unit___On___Bulb_Status__Bulb_on__Brightness_LeveL__Change_Brightness_Level();
			break;
	...
	/* Default react sequence for initial entry  */
	private void react__LED_Light_Unit___On___Bulb_Status__Bulb_on__Brightness_LeveL___entry_Default() {
		enterSequence__LED_Light_Unit___On___Bulb_Status__Bulb_on__Brightness_LeveL__Change_Brightness_Level_default();
	}
	...
	private long _LED_Light_Unit___On___Bulb_Status__Bulb_on__Brightness_LeveL__Change_Brightness_Level_react(long transitioned_before) {
		long transitioned_after = transitioned_before;
