...
public class DashboardFrame_Editor extends JFrame{
    ...
    public JFrame frame;
    public JPanel mainPanel, notifsPanel, testerPanel, smartFirePanel, smartTVPanel, smartLightPanel, smartMicrowavePanel;
    ...
    public Component createExitPanel() {
        /***********/
    	testerPanel = new JPanel(new GridLayout(4, 1, hGap, vGap));
    	testerPanel.setBorder(BorderFactory.createEmptyBorder(hGap, vGap, hGap, vGap));
