...
public class DashboardFrame_Editor extends JFrame{
    ...
    public static JButton smartFire_switch,
    				...
    				smartLight_switch, smartLight_use, smartLight_brightness, smartLight_led1, smartLight_led2,
    ...
    public Component createLightPanel() {
        ...
        smartLight_led1 = new JButton();
        smartLight_led1.setText("Light 1: OFF");
        smartLight_led2 = new JButton();
        smartLight_led2.setText("Light 2: OFF");
