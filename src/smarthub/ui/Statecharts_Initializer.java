			...
			public void actionPerformed(ActionEvent arg0) {
				anti_freeze = new Thread(new Runnable() {
					...
					public void run() {
						...
						LogReport.add("["+formatter.format(new Date())+")]: Smart Light Switch Toggled !\n");
					}
				});
				anti_freeze.start();
			}
			...
			public void actionPerformed(ActionEvent arg0) {
				anti_freeze = new Thread(new Runnable() {
					...
					public void run() {
						...
						LogReport.add("["+formatter.format(new Date())+")]: Smart Lights Luminosity Level: "+SmartHubSystem.getSL().getLights().brightness()+"\n");
					}
				});
				anti_freeze.start();
			}
