...
public class DashboardFrame_Editor extends JFrame{
    ...
    public static JButton smartFire_switch,
    				...
    				smartLight_switch, smartLight_use, smartLight_brightness, smartLight_switch1, smartLight_switch2,
    ...
    public static JSlider smartLight_led1, smartLight_led2;
    ...
    public Component createLightPanel() {
        ...
        smartLight_switch1 = new JButton();
        smartLight_switch1.setText("LED1 Status: OFF");
        smartLight_led1 = new JSlider();
        smartLight_led1.setFocusable(true);
        smartLight_led1.setMinimum(0);
        smartLight_led1.setMaximum(10);

        smartLight_switch2 = new JButton();
        smartLight_switch2.setText("LED2 Status: OFF");
        smartLight_led2 = new JSlider();
        smartLight_led2.setFocusable(true);
        smartLight_led2.setMinimum(0);
        smartLight_led2.setMaximum(10);
        
        
        smartLight_brightness = new JButton();
        smartLight_use.setText("Smart Light Usage: NOT IN USE");
        ...
        smartLightPanel.add(smartLight_switch1);
        smartLightPanel.add(smartLight_led1);
        smartLightPanel.add(smartLight_switch2);
